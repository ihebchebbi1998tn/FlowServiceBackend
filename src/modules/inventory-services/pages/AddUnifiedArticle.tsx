...
import { articleCategoriesApi, serviceCategoriesApi, locationsApi, LookupItem } from "@/services/api/lookupsApi";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const articleData = {
        ...
        stock: formData.stock ? parseInt(String(formData.stock)) : undefined,
        minStock: formData.minStock ? parseInt(String(formData.minStock)) : undefined,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link 
                      to={`/dashboard/lookups?tab=${articleType === 'material' ? 'articleCategories' : 'serviceCategories'}`}
                ...
                {articleType === 'material' && (
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Link 
                        to="/dashboard/lookups?tab=locations"
                        className="text-xs text-muted-foreground hover:text-primary flex items-center gap-1 transition-colors"
                      >
                        <Settings2 className="h-3 w-3" />
                        {t('addForm.manage')}
              ...
              {articleType === 'material' ? (
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="sellPrice">{t('addForm.sell_price')} *</Label>
                    <Input
                      id="sellPrice"
                      type="number"
                      step="0.01"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="basePrice">{t('addForm.price')} *</Label>
                    <Input
                      id="basePrice"
                      type="number"
                      step="0.01"
