...
import {
  ...
  ChevronDown, Loader2 as Loader2Icon, Sun, Moon, Sparkles,
            ...
            <div className="rounded-xl border border-border bg-card p-5 space-y-4 shadow-sm">
              ...
              {isInlineGenerating && (
                <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg bg-primary/5 border border-primary/10">
                  ...
                  <span className="text-xs text-primary font-medium">{t('dashboardBuilder.ai.generating')}</span>
                </div>
              )}
              ...
              <div className="flex items-center gap-0.5">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="ghost" size="icon" className="h-7 w-7 text-muted-foreground hover:text-foreground" onClick={() => handleDuplicate(activeDashboard)}>
                      <Copy className="h-3 w-3" />
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom" className="text-xs">{t('dashboardBuilder.duplicate')}</TooltipContent>
                </Tooltip>
                <Tooltip>
                  <TooltipTrigger asChild>
          ...
          {!isEditing && (
            <>
              ...
              <Tooltip>
                ...
                <TooltipContent side="bottom" className="text-xs">{t('dashboardBuilder.ai.title')}</TooltipContent>
              </Tooltip>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                ...
                <TooltipContent side="bottom" className="text-xs">
                  {isDark ? t('dashboardBuilder.configPanel.lightMode') : t('dashboardBuilder.configPanel.darkMode')}
                </TooltipContent>
              </Tooltip>
            </>
          )}
