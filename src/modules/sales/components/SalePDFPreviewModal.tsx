...
export function SalePDFPreviewModal({
  ...
  const pdfDocElement = useMemo(() => (
    <SalePDFDocument sale={sale} formatCurrency={formatCurrency} settings={pdfSettings} translations={pdfTranslations} installationsData={installationsData} />
  ), [sale, formatCurrency, pdfSettings, pdfTranslations, installationsData]);
