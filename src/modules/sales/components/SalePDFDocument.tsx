...
export function SalePDFDocument({ sale, formatCurrency, settings, translations, currencyCode = 'TND', language = 'en', signatureImage }: SalePDFDocumentProps) {
  const t = translations || {
    ...
    model: 'Model', serialNumber: 'Serial Number',
          ...
          {config.showElements?.itemsTable !== false && sale.items && sale.items.length > 0 && (
            <View style={styles.tableContainer} wrap={false}>
              ...
              {sale.items.map((item: any, index: number) => (
                ...
                >
                  ...
                  <View style={styles.descCol}>
                    <Text style={styles.cell}>{item.name || 'Item'}</Text>
              ...
              <View style={[styles.tableRow, { backgroundColor: '#F3F4F6', borderBottomWidth: 0 }]}>
                ...
                <View style={styles.descCol}>
                  <Text style={[styles.cellBold, { fontFamily: 'Helvetica-Bold' }]}>{t.subtotal} (HT)</Text>
                </View>
