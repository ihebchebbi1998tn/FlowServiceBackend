                ...
                <DialogContent className="max-w-lg">
                  ...
                  <div className="grid gap-4">
                    ...
                    {timeEntryMode === 'duration' ? (
                      /* Duration Input - Manual minutes */
                      <div>
                        <Label>{t('time_booking.duration_minutes')}</Label>
                        <Input 
                          type="number"
                          min="1"
              ...
              {aggregatedTimeEntries.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Start tracking your work time by adding your first time entry
                  </p>
                </div>
              ) : (
                <div className="space-y-3">
            ...
            <div className="max-h-[500px] overflow-y-auto pr-2">
              {aggregatedExpenses.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Track your project costs by adding your first expense
                  </p>
                </div>
              ) : (
                <div className="space-y-3">
