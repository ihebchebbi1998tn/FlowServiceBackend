...
interface SOPdfTranslations {
  ...
  model: string; serialNumber: string; manufacturer: string;
}
                    ...
                    <View style={{ backgroundColor: '#F9FAFB', paddingVertical: 4, paddingHorizontal: 10, borderBottomWidth: 1, borderBottomColor: '#E5E7EB', borderBottomStyle: 'solid' as any }}>
                      <View style={{ flexDirection: 'row', gap: 16 }}>
                        <View style={{ flexDirection: 'row', flex: 1 }}>
                          <Text style={{ fontSize: 8, color: '#6B7280', width: 60 }}>{tr.model}:</Text>
                          <Text style={{ fontSize: 8, color: '#1F2937' }}>{instModel}</Text>
                        </View>
                        <View style={{ flexDirection: 'row', flex: 1 }}>
                          <Text style={{ fontSize: 8, color: '#6B7280', width: 75 }}>{tr.serialNumber}:</Text>
                          <Text style={{ fontSize: 8, color: '#1F2937' }}>{instSerial}</Text>
                        </View>
                        <View style={{ flexDirection: 'row', flex: 1 }}>
                          <Text style={{ fontSize: 8, color: '#6B7280', width: 70 }}>{tr.manufacturer}:</Text>
