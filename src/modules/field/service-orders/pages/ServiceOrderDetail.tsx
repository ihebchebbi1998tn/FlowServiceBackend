                    ...
                    <div className="space-y-4">
                      ...
                      {selectedMaterial.internalComment && (
                        <div className="bg-muted/50 rounded-lg p-3">
                          <p className="text-xs text-muted-foreground mb-1 font-medium">Internal Comment (Staff Only)</p>
                      ...
                      {selectedMaterial.externalComment && (
                        <div className="bg-accent/30 rounded-lg p-3 border border-accent">
                          <p className="text-xs text-accent-foreground mb-1 font-medium">External Comment (Customer Visible)</p>
            ...
            {selectedMaterial && isEditingMaterial && (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label>External Comment (Customer Visible)</Label>
                    <Textarea 
