        ...
        <CardContent>
          {materialsWithDetails.length > 0 ? (
              ...
              <div className="mt-4 pt-4 border-t">
                <div className="flex justify-between items-center">
                  <div className="text-sm text-muted-foreground">
                    Total Materials: <span className="font-medium text-foreground">{materials.length} items</span>
                  </div>
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-sm font-medium text-foreground mb-2">No Materials Used Yet</h3>
              <p className="text-sm text-muted-foreground mb-4">Track materials and parts by adding your first entry</p>
              <Button 
                variant="outline" 
                size="sm" 
                className="gap-2"
        ...
        <Card className="mt-6">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium flex items-center gap-2">
              ...
              Installation Materials ({installationMaterials.length})
              <Badge variant="secondary" className="ml-2 text-xs">From Service Order</Badge>
            </CardTitle>
            <p className="text-sm text-muted-foreground mt-1">
              Materials linked to the same installation as this job
            </p>
          </CardHeader>
          <CardContent>
            <div className="overflow-x-auto">
                  ...
                  {installationMaterials.map((material) => (
                    <tr key={material.id} className="border-b hover:bg-muted/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-sm text-muted-foreground capitalize">
                        {material.source?.replace('_', ' ') || 'Manual'}
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            <div className="mt-4 pt-4 border-t">
              <div className="flex justify-between items-center">
                <div className="text-sm text-muted-foreground">
                  Total Installation Materials: <span className="font-medium text-foreground">{installationMaterials.length} items</span>
                </div>
                <div className="text-right">
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{materialToDelete?.resolvedArticleName}"? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
        ...
        <DialogContent className="max-w-md">
          ...
          {materialToEdit && (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="edit-internal-comment">Internal Comment</Label>
                <Textarea
