...
export function DispatchTimeExpensesTab({ 
  ...
  // Only allow adding time/expenses when dispatch is in_progress
    ...
    <Card>
        ...
        <div>
          <div className="flex flex-row items-center justify-between space-y-0 pb-4">
            ...
            <Button 
              ...
              title={!canAddEntries ? 'Dispatch must be In Progress to add time entries' : undefined}
            >
          ...
          {timeEntries.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-sm font-medium text-foreground mb-2">No Time Entries Yet</h3>
              <p className="text-sm text-muted-foreground mb-4">Start tracking your work time by adding your first time entry</p>
            </div>
          )}
        </div>
        ...
        <div>
          <div className="flex flex-row items-center justify-between space-y-0 pb-4">
            ...
            <Button 
              ...
              disabled={!canAddEntries}
              title={!canAddEntries ? 'Dispatch must be In Progress to add expenses' : undefined}
            >
              <Plus className="mr-2 h-4 w-4" />
              Add Expense
            </Button>
          ...
          {expenses.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-sm font-medium text-foreground mb-2">No Expenses Yet</h3>
              <p className="text-sm text-muted-foreground mb-4">Track your project costs by adding your first expense</p>
            </div>
          )}
        </div>
      </div>
      ...
      <Dialog open={isExpenseDialogOpen} onOpenChange={setIsExpenseDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => { setIsExpenseDialogOpen(false); setEditingExpenseId(null); resetExpenseForm(); }}>Cancel</Button>
