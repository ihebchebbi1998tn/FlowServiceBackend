...
export default function CreateInstallation() {
  ...
  const {
    ...
    formState: { errors },
    setValue,
  } = useForm<{name: string; model: string; manufacturer: string; serialNumber?: string; category: string; type?: string; location?: {address?: string; city?: string; state?: string; country?: string; zipCode?: string}}>();
  ...
  const onSubmit = (data: {name: string; model: string; manufacturer: string; serialNumber?: string; category: string; type?: string; location?: {address?: string; city?: string; state?: string; country?: string; zipCode?: string}}) => {
    if (!selectedCustomer) {
      toast({
