...
import { LogOut, Bell, Sidebar, LayoutGrid, User, Settings as SettingsIcon, Sun, Moon, Monitor, HelpCircle, PlayCircle, Sparkles, Search } from "lucide-react";
    ...
    <header data-tour="dashboard-header" className="h-14 border-b border-border bg-card sticky top-0 z-50">
      <div className="flex h-full items-center justify-between px-4 gap-4">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          {/* Help / Support button */}
          {!isMobile && (
            <Button data-tour="help-button" variant="ghost" size="icon" className="h-8 w-8" onClick={() => navigate('/dashboard/help')} title={t('help') || 'Help'}>
