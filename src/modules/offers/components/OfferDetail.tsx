...
import { ArrowLeft, Edit, Trash2, FileDown, RefreshCw, Send, Check, X, ShoppingCart, Loader2, MoreVertical, Zap, Info } from "lucide-react";
  ...
  const handleStatusFlowChange = async (newStatus: OfferStatus) => {
    ...
    try {
      ...
      if (positiveTerminals.includes(newStatus) && !workflowStatus.isActive) {
        ...
        // Auto-conversion happens silently via workflow
        // Wait for workflow to create the sale, then navigate to it
