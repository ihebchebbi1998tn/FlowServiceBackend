...
export function OfferPDFPreviewModal({
  ...
  const pdfDocElement = useMemo(() => (
    <OfferPDFDocument offer={offer} formatCurrency={formatCurrency} settings={pdfSettings} translations={pdfTranslations} />
  ), [offer, formatCurrency, pdfSettings, pdfTranslations]);
