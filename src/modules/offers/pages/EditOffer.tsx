...
import { ArrowLeft, Calendar as CalendarIcon, Save, Plus, Loader2, AlertTriangle } from "lucide-react";
...
export function EditOffer() {
  ...
  // Check if offer is converted (read-only)
  ...
  const onSubmit = async (data: OfferFormData) => {
    ...
    // Prevent editing converted offers
    if (isConverted) {
      toast.error(t('cannotEditConverted') || 'This offer has been converted and cannot be edited.');
      return;
    }
  ...
  return (
    <div className="flex flex-col">
      {/* Converted Offer Warning Banner */}
      {isConverted && (
          ...
          <div className="flex items-center gap-3 max-w-4xl mx-auto">
            ...
            <div>
              <p className="font-medium text-foreground">
                {t('convertedOfferWarning') || 'This offer has been converted to a sale'}
              </p>
              <p className="text-sm text-muted-foreground">
                {t('convertedOfferDescription') || 'Converted offers cannot be edited. Please edit the sale instead.'}
              </p>
            </div>
