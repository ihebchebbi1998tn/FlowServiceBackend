...
export function AiAssistantSidebar({ isOpen, onClose }: AiAssistantSidebarProps) {
  ...
  const handleSendMessage = async () => {
    ...
    // Run both intent detections in PARALLEL to avoid sequential delays
    const [formCreationCheck, taskCreationCheck] = await Promise.all([
    ...
    const isTaskCreationIntent = !isFormCreationIntent && taskCreationCheck.hasIntent;
