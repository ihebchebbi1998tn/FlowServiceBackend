...
namespace MyApi.Modules.Dispatches.Services
{
    public class DispatchService : IDispatchService
    {
        ...
        public async Task<NoteDto> AddNoteAsync(int dispatchId, CreateNoteDto dto, string userId)
        {
            ...
            return new NoteDto { Id = note.Id, DispatchId = note.DispatchId, Content = note.Content, Category = note.NoteType, CreatedBy = note.CreatedBy, CreatedAt = note.CreatedDate };
        }
