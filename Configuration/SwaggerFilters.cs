...
namespace MyApi.Configuration
{
    public class SwaggerResponseExamplesFilter : IOperationFilter
    {
        ...
        private void AddSuccessExample(OpenApiResponse response, Type? returnType)
        {
            ...
            if (example != null)
            {
                ...
                response.Content["application/json"].Example = Microsoft.OpenApi.Any.OpenApiAnyFactory.CreateFromJson(
                    System.Text.Json.JsonSerializer.Serialize(example, new System.Text.Json.JsonSerializerOptions 
                    { 
        ...
        private void AddErrorExample(OpenApiResponse response, string title, string detail)
        {
            ...
            response.Content["application/json"].Example = Microsoft.OpenApi.Any.OpenApiAnyFactory.CreateFromJson(
                System.Text.Json.JsonSerializer.Serialize(errorExample, new System.Text.Json.JsonSerializerOptions 
                { 
                    PropertyNamingPolicy = System.Text.Json.JsonNamingPolicy.CamelCase 
                })
            );
    ...
    public class SwaggerSchemaExamplesFilter : ISchemaFilter
    {
        public void Apply(OpenApiSchema schema, SchemaFilterContext context)
        {
            ...
            {
                schema.Example = Microsoft.OpenApi.Any.OpenApiAnyFactory.CreateFromJson(@"{
                    ""email"": ""user@example.com"",
