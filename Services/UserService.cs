    ...
    public class UserService : IUserService
    {
        ...
        public async Task<UserResponseDto> CreateUserAsync(CreateUserRequestDto createDto, string createdByUser)
        {
            try
            {
                ...
                if (await UserExistsAsync(createDto.Email))
                {
        ...
        public async Task<UserResponseDto?> UpdateUserAsync(int id, UpdateUserRequestDto updateDto, string modifiedByUser)
        {
            try
            {
                var user = await _context.Users
                ...
                {
                    if (await UserExistsAsync(updateDto.Email))
                    {
                        throw new InvalidOperationException("User with this email already exists");
                    }
